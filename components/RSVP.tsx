                ...
                <div>
                 ...
                 {attending === 'yes' && (
                    <div>
                        ...
                        <input type="number" id="guests" min="1" max="10" value={guests} onChange={e => setGuests(parseInt(e.target.value))} className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-[#B48A6E] focus:border-[#B48A6E]" />
                    </div>
                )}
