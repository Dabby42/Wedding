        ...
        <>
            ...
            <div className="fixed bottom-5 right-5 z-50">
                <button
                    ...
                    className="bg-[#B48A6E] text-white rounded-full p-3 shadow-lg hover:bg-[#a57b60] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#B48A6E]"
